...
| contracts/core/GasXWhitelistPaymaster.sol | 107 |
...
- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 39](contracts/core/GasXWhitelistPaymaster.sol#L39)
...
- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 216](contracts/core/GasXWhitelistPaymaster.sol#L216)

	```solidity
	    function setLimit(uint256 gas, uint256 usd) external onlyOwner {
	```

- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 226](contracts/core/GasXWhitelistPaymaster.sol#L226)

	```solidity
	    function setSelector(bytes4 sel, bool allowed) external onlyOwner {
	```

- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 235](contracts/core/GasXWhitelistPaymaster.sol#L235)
...
- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 249](contracts/core/GasXWhitelistPaymaster.sol#L249)
...
- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 149](contracts/core/GasXWhitelistPaymaster.sol#L149)

	```solidity
	        if (pData.length > 52) {
	```

- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 274](contracts/core/GasXWhitelistPaymaster.sol#L274)

	```solidity
	        bytes calldata data = pData[52:];
	```

- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 275](contracts/core/GasXWhitelistPaymaster.sol#L275)

	```solidity
	        require(data.length >= 6, "invalid paymaster data length for expiry");
	```

- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 276](contracts/core/GasXWhitelistPaymaster.sol#L276)

	```solidity
	        expiry = uint48(bytes6(data[:6]));
	```

- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 277](contracts/core/GasXWhitelistPaymaster.sol#L277)
...
- Found in contracts/core/GasXWhitelistPaymaster.sol [Line: 70](contracts/core/GasXWhitelistPaymaster.sol#L70)
